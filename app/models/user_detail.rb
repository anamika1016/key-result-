class UserDetail < ApplicationRecord
  ...
  validates :department_id, uniqueness: { scope: [ :activity_id, :employee_detail_id, :year ],
                                         message: "A record already exists for this department, activity, employee, and year combination" }
